...
traffic_debug.o: traffic_debug.c traffic_debug.h callback_stream_log.h callback_stream_analyze.h time_analysis.h callback_detect_stream.h detect_stream.h handle_init.h global.h
	$(CC) $(CFLAGS) -c $<

callback_stream_log.o: callback_stream_log.c callback_stream_log.h
	$(CC) $(CFLAGS) -c $<

callback_stream_analyze.o: callback_stream_analyze.c callback_stream_analyze.h time_analysis.h global.h
	$(CC) $(CFLAGS) -c $<

time_analysis.o: time_analysis.c time_analysis.h
	$(CC) $(CFLAGS) -c $<

callback_detect_stream.o: callback_detect_stream.c callback_detect_stream.h global.h
	$(CC) $(CFLAGS) -c $<
